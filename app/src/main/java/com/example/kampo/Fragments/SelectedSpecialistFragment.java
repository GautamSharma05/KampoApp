    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container,
        ...
        binding.dayDatePicker.getSelectedDate(date -> {
            if(date != null){
                ...
                DocumentReference documentReference = fStore.collection("Workers").document(WorkerId).collection("Appointment").document(dateSelected);
                documentReference.addSnapshotListener(new EventListener<DocumentSnapshot>() {
                    ...
                    public void onEvent(@Nullable @org.jetbrains.annotations.Nullable DocumentSnapshot value, @Nullable @org.jetbrains.annotations.Nullable FirebaseFirestoreException error) {
                        if(value != null){
                            ...
                            slot_4 = value.getBoolean("01:00PM");
                        }
        ...
        binding.bookFinalAppointment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String services = binding.finalCustomerWantServices.getText().toString();
                ...
                //checking that  atLeast one slot is selected or not
                    ...
                    binding.finalCustomerWantServices.setError("At least One Service is Required");
                }
                ...
                //Checking Slot Availability from Firebase Database
                    ...
                    if(result.equals("10:00AM")){
                        if(slot_1){
                            ...
                            appCompatActivity.getSupportFragmentManager().beginTransaction().replace(R.id.frameContainer,new PaymentFragment(WorkerId,FullName,dateSelected,result,services)).addToBackStack(null).commit();
                        }
                        else{
